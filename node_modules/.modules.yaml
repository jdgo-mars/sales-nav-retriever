...
hoistedDependencies:
  ...
  '@aklinker1/rollup-plugin-visualizer@5.12.0(rollup@4.34.4)':
  ...
  '@types/yauzl@2.10.3':
    '@types/yauzl': private
  '@vitejs/plugin-react@4.3.4(vite@6.0.8(@types/node@22.13.1)(jiti@1.21.7))':
  ...
  vite-node@2.1.9(@types/node@22.13.1):
    vite-node: private
  vite@6.0.8(@types/node@22.13.1)(jiti@1.21.7):
    vite: private
  watchpack@2.4.1:
    watchpack: private
  wcwidth@1.0.1:
...
pendingBuilds: []
prunedAt: Thu, 06 Feb 2025 21:02:18 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
